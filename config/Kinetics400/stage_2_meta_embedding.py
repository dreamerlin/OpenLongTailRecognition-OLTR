...
training_opt = {}
training_opt['dataset'] = 'Kinetics400'
training_opt['log_dir'] = './logs/Kinetics400/meta_embedding'
training_opt['num_classes'] = 400
...
networks['feat_model'] = {'def_file': './models/ResNet50CLIPFeature.py',
